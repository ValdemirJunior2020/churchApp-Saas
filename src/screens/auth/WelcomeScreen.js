// REPLACE: src/screens/auth/WelcomeScreen.js
  ...
  return (
    <View style={styles.root}>
      <View style={styles.card}>
        ...
        <Text style={styles.title}>Your Church, Connected</Text>
        <Text style={styles.sub}>Login is Firebase Email/Password. No Google Sheets. No Apps Script.</Text>
...
const styles = StyleSheet.create({
  ...
  primary: { marginTop: 16, height: 52, borderRadius: 18, alignItems: "center", justifyContent: "center", backgroundColor: "#0f172a" },
  primaryText: { color: "white", fontWeight: "900" },
  secondary: { marginTop: 10, height: 52, borderRadius: 18, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(15,23,42,0.08)", borderWidth: 1, borderColor: "rgba(15,23,42,0.12)" },
